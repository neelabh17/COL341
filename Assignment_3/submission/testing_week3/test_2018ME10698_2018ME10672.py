...
ENSEMBLE_MODELS = ['E1', 'E2', 'E3', "E5", "E6"]
...
ENSEMBLE_CONFIG = {
    ...
    'E5': {
        "MODEL": model1,
        'BASELINE': EfficientNet.from_pretrained('efficientnet-b5'),
    },
    'E6': {
        "MODEL": model1,
        'BASELINE': EfficientNet.from_pretrained('efficientnet-b6'),
    }
}
...
if __name__ == "__main__":
    ...
    if not TRAIN:
        ...
        def load_models():
            ...
            #     args["modelpath"], f"{emodel}_4_{NEELARYA_MODEL_NAME}"))
